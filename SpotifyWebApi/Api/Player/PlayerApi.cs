namespace SpotifyWebApi.Api.Player
{
    ...
    public class PlayerApi : BaseApi, IPlayerApi
    {
        ...
        public PlayerApi(Token token, HttpClient httpClient)
        ...
        {
            var r = await this.GetAsync<DeviceList>(MakeUri("me/player/devices"));
        ...
        {
            var r = await this.GetAsync<CurrentlyPlayingContext>(
                        MakeUri(
                            $"me/player",
                            ("market", market)));
        ...
        {
            var r = await this.GetAsync<CurrentlyPlaying>(
                        MakeUri(
